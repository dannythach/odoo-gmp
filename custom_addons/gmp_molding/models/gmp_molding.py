...
class gmpmolding(models.Model):
    ...
    mold_chain_system_id = fields.Char(string="Hệ thống dây khuôn (Mã số)")
    mold_type_info = fields.Char(string="Loại khuôn (QC/ Kích thước)")
    ...
    def copy(self, default=None):
        ...
        return super(gmpmolding, self).copy(default)

...
class GmpCuttingWizard(models.TransientModel):
    _name = "gmp.cutting.wizard"
    ...
    valid_item_ids = fields.Many2many(
        'gmp.oitm', 
        'gmp_cutting_wizard_item_rel', 
        'wizard_id', 'item_id', 
        string='Sản phẩm hợp lệ'
    )
    valid_material_ids = fields.Many2many(
        'gmp.oitm', 
        'gmp_cutting_wizard_material_rel', 
    ...
    def action_confirm(self):
        ...
        if self.line_id:
            ...
            self.env['gmp.cutting.line'].create(vals)

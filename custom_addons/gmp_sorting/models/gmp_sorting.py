...
class gmpsorting(models.Model):
    ...
    substandard_defect_name = fields.Float(string="Tên lỗi thứ phẩm")
    reject_defect_name = fields.Float(string="Tên lỗi phế phẩm")
    ...
    def copy(self, default=None):
        ...
        return super(gmpsorting, self).copy(default)

...
class GmpWeighingMonitoringWizard(models.TransientModel):
    ...
    valid_item_ids = fields.Many2many(
        'gmp.oitm', 
        'gmp_weighing_wizard_item_rel', 
        'wizard_id', 'item_id', 
        string='Sản phẩm hợp lệ'
    )
    valid_material_ids = fields.Many2many(
        'gmp.oitm', 
        'gmp_weighing_wizard_material_rel', 
    ...
    def action_confirm(self):
        ...
        if self.line_id:
            ...
            self.env['gmp.weighing.monitoring.line'].create(vals)
